...
('TRANSACTION_CONFIG_USD', JSON_OBJECT('txMinAmt', 1.0, 'txMaxAmt', 1000.0, 'txOtpRequired', 0), CURRENT_TIMESTAMP, NULL, 'OBC_SYSTEM'),
('TRANSACTION_CONFIG_KHR', JSON_OBJECT('txMinAmt', 10.0, 'txMaxAmt', 10000.0, 'txOtpRequired', 0), CURRENT_TIMESTAMP, NULL, 'OBC_SYSTEM'),
...
('TRX_QUERY_MAX_DURATION', JSON_OBJECT('value', 40), CURRENT_TIMESTAMP, NULL, 'OBC_SYSTEM');
