...
VALUES
    ...
    ('PGP_CONFIG', JSON_OBJECT('pgpKeyPath', '/key/secretKey.ASC', 'pgpPassphrase', 'password'), CURRENT_TIMESTAMP, NULL, 'OBC_SYSTEM'),
    ('SIBS_DATE_CONFIG', JSON_OBJECT('useSIBSSyncDate', 'true', 'sibsSyncDate', '2023-03-20'), CURRENT_TIMESTAMP, NULL, 'OBC_SYSTEM');