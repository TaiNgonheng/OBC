...
ALTER TABLE obc.tbl_obc_transaction_archive ADD CONSTRAINT tbl_obc_transaction_archive_FK FOREIGN KEY (user_id) REFERENCES obc.tbl_obc_profile(id) ON DELETE CASCADE;