...
public class SFTPUtil {
  ...
  public byte[] downloadFileFromSFTP(String filename) throws IOException, URISyntaxException {
    ...
    String sftpCredentials = String.format("%s:%s", applicationProperties.getSftpUsername(), applicationProperties.getSftpPassword());
    ...
    URI maskedUri =
        new URI(
            "sftp", "***:***", applicationProperties.getSftpHost(), applicationProperties.getSftpPort(), path, null, null);
